...
export class Buffs {
    ...
    public setDecreaseDamageTaken(params: { damageType: DamageType, value: number, skillType: SkillClassType, class?: SkillClassType }) {
    ...
    public getDecreaseDamageTaken(params: { damageType: DamageType, skillType: SkillClassType, class?: SkillClassType }) {
        ...
        if (this.decreaseDamageTaken[SkillClassType.Any] !== undefined) {
            res.decreased += this.decreaseDamageTaken[SkillClassType.Any][damageType] || 0
            res.decreased += this.decreaseDamageTaken[SkillClassType.Any][DamageType.True] || 0
    ...
    public getAbsorbDamage(params: { skillType: SkillClassType, damageType: DamageType }) {
        const { skillType, damageType } = params
        const res = {
            conversionRate: 0,
        ...
        if (this.absorbDamage[SkillClassType.Any] !== undefined) {
            ...
            res.conversionRate += (this.absorbDamage[SkillClassType.Any][damageType] || 0) + t
