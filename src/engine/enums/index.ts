...
export enum ReiatsuTypes {
    Hakuda, Kidou, Reiryoku, Zanpakutou, Random
}

export enum CharacterTypes {
    Human, Shinigami, Hollow, Arrancar, Captain, Visored, Fullbringerß
}
...
export enum effectType {
    ...
    DestructibleDefense, EnableEffects, SkillCostChange
}
...
export enum DamageType {
    None, Normal, Piercing, Affliction, True, Any
}

export enum Types {
    Human, Hollow, Shinigami, Fullbringer, Quincy, Captain
}
...
export enum SkillClassType {
    None, Physical, Reiatsu, Strategic, Affliction, Any
}
