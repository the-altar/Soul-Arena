...
group by
	...
	ur."name");
`;
exports.trackMissionQuery = `INSERT INTO tracking_mission
(mission_id, goals, user_id)
VALUES($1, $2, $3);`;
exports.missionTrackQuery = `select goals from tracking_mission where user_id = $1 and mission_id = $2`;
exports.deleteMissionTrackQuery = `delete
from
    public.tracking_mission
where
    user_id = $1
    and mission_id = $2;`;
exports.selectMissionQuery = `select
m2.*,
case
...
group by
    entity.id;        
`;
exports.selectThemeQuery = `select * from theme where theme."permission" <= $1`;
exports.updateUserThemeQuery = `UPDATE users SET preferred_theme=$2 WHERE users.id = $1;
`;
//# sourceMappingURL=game.queries.js.map